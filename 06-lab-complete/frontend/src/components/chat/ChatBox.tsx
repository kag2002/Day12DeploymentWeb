...
import {
  Sparkles, MessageSquare, Terminal, Lightbulb,
  ShieldCheck, Brain, Search, Wand2, CheckCircle2,
  Globe, BookOpen
} from 'lucide-react';
...
const STEPS: Array<{
...
}> = [
  {
    ...
    sublabel: 'Tải prompt & đặc tả công cụ',
    Icon: Sparkles,
  ...
  },
  {
    ...
    sublabel: 'Agent đang lập kế hoạch nghiên cứu',
    Icon: Brain,
  ...
  {
    key: 'searching',
    label: 'Truy xuất nguồn tin',
    sublabel: 'Gọi công cụ (Tavily/Twitter/arXiv)...',
    Icon: Search,
    color: 'text-cyan-400',
  ...
  },
  {
    ...
    sublabel: 'Đọc chi tiết bài viết & papers',
    Icon: BookOpen,
  ...
  {
    key: 'generating',
    label: 'Tổng hợp bản tin',
    sublabel: 'Biên soạn kết quả dạng Markdown',
    Icon: Wand2,
  ...
  return (
    <div className="flex w-full gap-4 py-5 px-4 bg-[#0f1422]/40 border-y border-slate-800/50">
      ...
      <div className="flex-1 flex flex-col gap-3 min-w-0">
        <span className="text-xs font-semibold text-slate-300 select-none">Research Agent · Đang xử lý</span>
        ...
        <p className="text-[10px] text-slate-600 select-none">
          ⏱ Thời gian xử lý tối đa ~60s/lần gọi · Tối đa 4 vòng Agent Loop
        </p>
      </div>
    </div>
  );
  ...
  const promptCards = [
    {
      ...
      title: "Bài đăng Twitter",
      description: "Lấy bài đăng gần đây của một tài khoản cụ thể.",
      prompt: "Hãy lấy các bài đăng gần đây của screenname sama."
    },
    {
      icon: <Globe className="w-5 h-5 text-cyan-400" />,
      title: "Tìm kiếm tin tức Web",
      description: "Tìm kiếm thông tin cập nhật qua Tavily API.",
      prompt: "Tìm kiếm tin tức công nghệ mới nhất về OpenAI GPT-5."
    },
    {
      icon: <Search className="w-5 h-5 text-emerald-400" />,
      title: "Đọc nội dung URL",
      description: "Cào và tóm tắt bài viết từ URL bất kỳ.",
      prompt: "Đọc nội dung và tóm tắt bài viết tại link: https://openai.com/research/"
    },
    {
      icon: <BookOpen className="w-5 h-5 text-amber-400" />,
      title: "Nghiên cứu arXiv papers",
      description: "Tìm kiếm tài liệu học thuật arXiv và trích xuất text.",
      prompt: "Tìm kiếm các bài nghiên cứu arXiv mới nhất về Prompt Engineering."
    }
  ];
        ...
        <div className="flex-1 flex flex-col items-center justify-center max-w-3xl mx-auto px-6 py-12 select-none">
          <div className="flex flex-col items-center text-center gap-3.5 mb-10">
            ...
            <p className="text-sm text-slate-400 max-w-md leading-relaxed">
              Trợ lý AI đa năng hỗ trợ tìm kiếm web, đọc URL, theo dõi mạng xã hội và nghiên cứu học thuật arXiv. Bắt đầu bằng cách chọn một gợi ý bên dưới!
            </p>
          </div>
